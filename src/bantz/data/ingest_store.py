...
_TOOL_DATA_CLASS: Dict[str, DataClass] = {
    ...
    "gmail.list_messages":      DataClass.EPHEMERAL,
    "gmail.unread_count":       DataClass.EPHEMERAL,
    "gmail.smart_search":       DataClass.EPHEMERAL,
    "calendar.list_events":     DataClass.EPHEMERAL,
    "web.search":               DataClass.EPHEMERAL,
    "web.scrape":               DataClass.EPHEMERAL,
    # Sync-powered search tools → ephemeral (read from local DB)
    "inbox.search":             DataClass.EPHEMERAL,
    "inbox.by_category":        DataClass.EPHEMERAL,
    "inbox.categories":         DataClass.EPHEMERAL,
    "inbox.summary":            DataClass.EPHEMERAL,
    "calendar.upcoming":        DataClass.EPHEMERAL,
    "calendar.search":          DataClass.EPHEMERAL,
    "news.latest":              DataClass.EPHEMERAL,
    "news.search":              DataClass.EPHEMERAL,
    # Write/action tools → session
    "gmail.send_email":         DataClass.SESSION,
    "gmail.send":               DataClass.SESSION,
