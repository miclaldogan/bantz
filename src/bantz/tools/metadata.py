...
_FALLBACK_TOOL_REGISTRY: dict[str, ToolRisk] = {
    ...
    "contacts.search": ToolRisk.SAFE,
    "contacts.get": ToolRisk.SAFE,
    ...
    "pdf.extract_text": ToolRisk.SAFE,
    "pdf.summarize": ToolRisk.SAFE,
    "pdf.from_attachment": ToolRisk.MODERATE,
    "google.classroom.courses": ToolRisk.SAFE,
    "google.classroom.coursework": ToolRisk.SAFE,
    "google.classroom.submissions": ToolRisk.SAFE,
    "news.latest": ToolRisk.SAFE,
    "news.search": ToolRisk.SAFE,
    "news.briefing": ToolRisk.SAFE,
    "news.category": ToolRisk.SAFE,
    ...
    "gmail.send": ToolRisk.DESTRUCTIVE,
    "gmail.send_to_contact": ToolRisk.DESTRUCTIVE,
    "gmail.send_draft": ToolRisk.DESTRUCTIVE,
    ...
    # Runtime tools using underscore naming convention (Issue #663 compliance)
    "browser_back": ToolRisk.SAFE,
    "browser_click": ToolRisk.MODERATE,
    "browser_detail": ToolRisk.SAFE,
    "browser_info": ToolRisk.SAFE,
    "browser_open": ToolRisk.MODERATE,
    "browser_scan": ToolRisk.SAFE,
    "browser_scroll_down": ToolRisk.SAFE,
    "browser_scroll_up": ToolRisk.SAFE,
    "browser_search": ToolRisk.SAFE,
    "browser_type": ToolRisk.MODERATE,
    "browser_wait": ToolRisk.SAFE,
    "calendar.apply_plan_draft": ToolRisk.MODERATE,
    "calendar.plan_events_from_draft": ToolRisk.MODERATE,
    "clipboard_get": ToolRisk.MODERATE,
    "clipboard_set": ToolRisk.MODERATE,
    "code_format": ToolRisk.MODERATE,
    "code_replace_function": ToolRisk.MODERATE,
    "file_create": ToolRisk.MODERATE,
    "file_edit": ToolRisk.MODERATE,
    "file_read": ToolRisk.SAFE,
    "file_search": ToolRisk.SAFE,
    "file_undo": ToolRisk.MODERATE,
    "file_write": ToolRisk.MODERATE,
    "pc_hotkey": ToolRisk.MODERATE,
    "pc_mouse_click": ToolRisk.MODERATE,
    "pc_mouse_move": ToolRisk.SAFE,
    "pc_mouse_scroll": ToolRisk.SAFE,
    "project_info": ToolRisk.SAFE,
    "project_search_symbol": ToolRisk.SAFE,
    "project_symbols": ToolRisk.SAFE,
    "project_tree": ToolRisk.SAFE,
    "terminal_background": ToolRisk.MODERATE,
    "terminal_background_kill": ToolRisk.DESTRUCTIVE,
    "terminal_background_list": ToolRisk.SAFE,
    "terminal_run": ToolRisk.MODERATE,
}
