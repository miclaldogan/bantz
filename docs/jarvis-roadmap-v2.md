...
> **Canonical Source** - Bu dosya Bantz/Jarvis V2 roadmap'inin tek kaynağıdır.
> 
...
| # | Issue | Status |
|---|-------|--------|
| 30 | [V2-0: Product Definition](https://github.com/miclaldogan/bantz/issues/30) | 🔨 In Progress |
| 31 | [V2-1: Agent OS Core](https://github.com/miclaldogan/bantz/issues/31) | 📋 Planned |
| 32 | [V2-2: Tool Runtime](https://github.com/miclaldogan/bantz/issues/32) | 📋 Planned |
| 33 | [V2-3: Cite-first Research](https://github.com/miclaldogan/bantz/issues/33) | 📋 Planned |
| 34 | [UI-2: Jarvis Panel](https://github.com/miclaldogan/bantz/issues/34) | 📋 Planned |
| 35 | [Voice-2: Attention Gate](https://github.com/miclaldogan/bantz/issues/35) | 📋 Planned |
| 36 | [V2-4: Memory System](https://github.com/miclaldogan/bantz/issues/36) | 📋 Planned |
| 37 | [V2-5: Privacy & Security](https://github.com/miclaldogan/bantz/issues/37) | 📋 Planned |
| 38 | [V2-6: Conversation Engine](https://github.com/miclaldogan/bantz/issues/38) | 📋 Planned |
| 39 | [V2-7: Document Pipeline](https://github.com/miclaldogan/bantz/issues/39) | 📋 Planned |
| 40 | [V2-8: Agentic Automation](https://github.com/miclaldogan/bantz/issues/40) | 📋 Planned |
...
MVP done = Aşağıdaki 3 senaryo başarıyla tamamlanıyor:

| Senaryo | Açıklama | Done Kriterleri |
|---------|----------|-----------------|
| S1 | Araştırma + Özet | ACK ≤0.2s, kaynak ≥2, özet ≤30s |
| S2 | Hava + Takvim entegrasyonu | İzin isteme, multi-tool |
| S3 | Roadmap/plan oluşturma | Deadline analizi, günlere bölme |

### Timing Requirements

Ayrıntılar için bkz: [Acceptance Tests](acceptance-tests.md)

```python
# src/bantz/core/timing.py
class TimingRequirements:
    ACK_MAX_MS = 200           # 0.2 saniye - TTS "Anladım" response
    FIRST_SOURCE_MIN_S = 3     # Minimum kaynak bulma (gerçekçi)
    FIRST_SOURCE_MAX_S = 10    # Maximum kaynak bulma
    SUMMARY_MAX_S = 30         # Özet hazırlama süresi
    PERMISSION_PROMPT_REQUIRED = True  # İzin isteme zorunlu mu?
```
